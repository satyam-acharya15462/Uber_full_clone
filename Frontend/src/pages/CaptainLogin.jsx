...
const CaptainLogin = () => {
  ...
  return (
    ...
    <div>
    <Link to='/login' className='bg-[#2E7D32] flex justify-center items-center text-white font-semibold mt-1 rounded px-2 py-2  w-full text-lg placeholder:text-base'>sign in as User</Link>
    </div>
    </div>
  )
}
